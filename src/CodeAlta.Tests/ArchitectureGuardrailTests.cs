...
public sealed class ArchitectureGuardrailTests
{
    ...
    public void FrontendCoordinators_DoNotAddUntrackedFireAndForgetTasks()
    {
        ...
        var allowedLegacySites = new HashSet<string>(StringComparer.Ordinal)
        {
            ...
            "App/ShellThreadStateCoordinator.cs:284:_ = RestoreStartupThreadHistoryAsync(threadId, cancellationToken);",
            "App/ShellThreadStateCoordinator.cs:293:_ = PersistViewStateAsync();",
            "App/ShellThreadStateCoordinator.cs:307:_ = PersistViewStateAsync();",
            "App/ShellThreadStateCoordinator.cs:363:_ = PersistViewStateAsync();",
            "App/ShellThreadStateCoordinator.cs:366:_ = _ensureThreadHistoryLoadedAsync(thread, CancellationToken.None);",
            "App/ShellThreadStateCoordinator.cs:458:_ = PersistViewStateAsync();",
            "App/ShellThreadStateCoordinator.cs:496:_ = PersistViewStateAsync();",
