...
public sealed class ArchitectureGuardrailTests
{
    ...
    public void FrontendCoordinators_DoNotAddUntrackedFireAndForgetTasks()
    {
        ...
        var allowedLegacySites = new HashSet<string>(StringComparer.Ordinal)
        {
            ...
            "App/ShellSessionStateCoordinator.cs:282:_ = RestoreStartupSessionHistoryAsync(sessionId, cancellationToken);",
            "App/ShellSessionStateCoordinator.cs:293:_ = PersistViewStateAsync();",
            "App/ShellSessionStateCoordinator.cs:308:_ = PersistViewStateAsync();",
            "App/ShellSessionStateCoordinator.cs:379:_ = PersistViewStateAsync();",
            "App/ShellSessionStateCoordinator.cs:517:_ = PersistViewStateAsync();",
            "App/ShellSessionStateCoordinator.cs:566:_ = PersistViewStateAsync();",
