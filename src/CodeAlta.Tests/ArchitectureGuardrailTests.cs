...
public sealed class ArchitectureGuardrailTests
{
    ...
    public void FrontendCoordinators_DoNotAddUntrackedFireAndForgetTasks()
    {
        ...
        var allowedLegacySites = new HashSet<string>(StringComparer.Ordinal)
        {
            ...
            "App/ThreadRuntimeEventCoordinator.cs:102:_ = ObservePluginAgentEventAsync(thread, agentRuntimeEvent.Event);",
            "App/ThreadRuntimeEventCoordinator.cs:118:_ = ObservePluginAgentEventAsync(thread, @event);",
            "App/ThreadRuntimeEventCoordinator.cs:184:_ = InvalidateProjectFileSearchAsync(thread.WorkingDirectory);",
